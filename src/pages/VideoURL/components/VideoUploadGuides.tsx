...
const VideoUploadGuides = () => {
  return (
    <div className="rounded-2xl border border-gray-200 dark:bg-white/[0.03] bg-white dark:border-gray-800 p-8">
      <h3 className="text-lg font-semibold text-brand-500 dark:text-brand-400 mb-4 flex items-center gap-2">
        <AlertCircle className="w-5 h-5 text-brand-500 dark:text-brand-400" />
        Video Upload Guidelines
      </h3>
      <ul className="space-y-3 text-gray-900 dark:text-white">
        <li className="flex items-start gap-3">
          <span className="w-2 h-2 bg-brand-500 dark:bg-brand-400 rounded-full mt-2 flex-shrink-0"></span>
          <span>
