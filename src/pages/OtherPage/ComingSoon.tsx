    ...
    <>
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
        ...
        <div className="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
          <h1 className=" font-semibold text-gray-800 text-title-base dark:text-white/90 xl:text-title-lg">
            We Are
          </h1>
          <h1 className="mb-8 font-bold text-[#7592ff] text-title-md xl:text-title-2xl">
            COMING VERY SOON
          </h1>
